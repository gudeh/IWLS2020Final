...
for path in os.listdir('./Benchmarks/'):
	...
	with open("%s/%s.train.pla" % (folderOut, base_name), 'w') as fOutTrain, open("%s/%s.valid.pla" % (folderOut, base_name), 'w') as fOutValid, open("%s/%s.valid_2.pla" % (folderOut, base_name), 'w') as fOutValid2:
	...
	with open("Benchmarks_3/%s.train.pla" % (base_name),"r") as fTrain, open("Benchmarks_3/%s.valid.pla" % (base_name),"r") as fValid, open("Benchmarks_3/%s.valid_2.pla" % (base_name),"r") as fValid2:
		linesTrain = fTrain.readlines()
